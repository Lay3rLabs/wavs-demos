...
See the [wrapper's documentation](`NativeCurrencyPaymentFallbackInstance`) for more details.*/
    ...
    >(
        ...
        NativeCurrencyPaymentFallbackInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<NativeCurrencyPaymentFallbackInstance<T, P, N>>,
    > {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<NativeCurrencyPaymentFallbackInstance<T, P, N>> {
