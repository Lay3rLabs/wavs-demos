...
pub mod Nonces {
    ...
    impl alloy_sol_types::SolInterface for NoncesCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<NoncesCalls>] = &[{
                fn nonces(data: &[u8], validate: bool) -> alloy_sol_types::Result<NoncesCalls> {
    ...
    impl alloy_sol_types::SolInterface for NoncesErrors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<NoncesErrors>] = &[{
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<NoncesInstance<T, P, N>>> {
        ...
        > NoncesInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<NoncesInstance<T, P, N>> {
