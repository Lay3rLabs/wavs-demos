...
pub mod IERC4906 {
    ...
    ///Container for all the [`IERC4906`](self) function calls.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC4906Calls {
        const NAME: &'static str = "IERC4906Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<IERC4906Calls>] = &[
                {
                    fn supportsInterface(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<IERC4906Calls> {
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            data, validate,
                        )
                        .map(IERC4906Calls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                ...
                },
                {
                    fn transferFrom(
                        ...
                        .map(IERC4906Calls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn safeTransferFrom_0(
                        ...
                        .map(IERC4906Calls::safeTransferFrom_0)
                    }
                    safeTransferFrom_0
                },
                {
                ...
                },
                {
                    fn setApprovalForAll(
                        ...
                        .map(IERC4906Calls::setApprovalForAll)
                    }
                    setApprovalForAll
                },
                {
                    fn safeTransferFrom_1(
                        ...
                        .map(IERC4906Calls::safeTransferFrom_1)
                    }
                    safeTransferFrom_1
                },
                {
                    fn isApprovedForAll(
                        ...
                        .map(IERC4906Calls::isApprovedForAll)
                    }
                    isApprovedForAll
                },
            ];
    ...
    ///Container for all the [`IERC4906`](self) events.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC4906Events {
        const NAME: &'static str = "IERC4906Events";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC4906Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IERC4906`](self) contract instance.

    See the [wrapper's documentation](`IERC4906Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC4906Instance<T, P, N> {
        IERC4906Instance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC4906Instance<T, P, N>>>
    {
        IERC4906Instance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IERC4906Instance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC4906`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IERC4906`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IERC4906Instance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC4906Instance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC4906Instance").field(&self.address).finish()
        }
    }
        ...
        > IERC4906Instance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IERC4906Instance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> IERC4906Instance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC4906Instance<T, P, N> {
            IERC4906Instance {
