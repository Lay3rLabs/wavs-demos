...
pub mod IVotes {
    ...
    impl alloy_sol_types::SolInterface for IVotesCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<IVotesCalls>] = &[
                {
                    fn getPastVotes(
                        data: &[u8],
                        validate: bool,
    ...
    impl alloy_sol_types::SolInterface for IVotesErrors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<IVotesErrors>] = &[{
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IVotesInstance<T, P, N>>> {
        ...
        > IVotesInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IVotesInstance<T, P, N>> {
