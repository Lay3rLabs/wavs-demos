...
pub mod ERC721URIStorage {
    ...
    ///Container for all the [`ERC721URIStorage`](self) function calls.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC721URIStorageCalls {
        const NAME: &'static str = "ERC721URIStorageCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<ERC721URIStorageCalls>] = &[
                {
                    fn supportsInterface(
                        ...
                        .map(ERC721URIStorageCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn name(
                        ...
                        <nameCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721URIStorageCalls::name)
                    }
                    name
                },
                {
                    fn getApproved(
                        ...
                        .map(ERC721URIStorageCalls::getApproved)
                    }
                    getApproved
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721URIStorageCalls::approve)
                    }
                    approve
                },
                {
                    fn transferFrom(
                        ...
                        .map(ERC721URIStorageCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn safeTransferFrom_0(
                        ...
                        .map(ERC721URIStorageCalls::safeTransferFrom_0)
                    }
                    safeTransferFrom_0
                },
                {
                    fn ownerOf(
                        ...
                        <ownerOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721URIStorageCalls::ownerOf)
                    }
                    ownerOf
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721URIStorageCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn symbol(
                        ...
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721URIStorageCalls::symbol)
                    }
                    symbol
                },
                {
                    fn setApprovalForAll(
                        ...
                        .map(ERC721URIStorageCalls::setApprovalForAll)
                    }
                    setApprovalForAll
                },
                {
                    fn safeTransferFrom_1(
                        ...
                        .map(ERC721URIStorageCalls::safeTransferFrom_1)
                    }
                    safeTransferFrom_1
                },
                {
                    fn tokenURI(
                        ...
                        <tokenURICall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721URIStorageCalls::tokenURI)
                    }
                    tokenURI
                },
                {
                    fn isApprovedForAll(
                        ...
                        .map(ERC721URIStorageCalls::isApprovedForAll)
                    }
                    isApprovedForAll
                },
            ];
    ...
    ///Container for all the [`ERC721URIStorage`](self) custom errors.
    pub enum ERC721URIStorageErrors {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC721URIStorageErrors {
        const NAME: &'static str = "ERC721URIStorageErrors";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<ERC721URIStorageErrors>] = &[
                {
                    fn ERC721InsufficientApproval(
                        ...
                        .map(ERC721URIStorageErrors::ERC721InsufficientApproval)
                    }
                ...
                },
                {
                    fn ERC721InvalidOperator(
                        ...
                        .map(ERC721URIStorageErrors::ERC721InvalidOperator)
                    }
                ...
                },
                {
                    fn ERC721IncorrectOwner(
                        ...
                        .map(ERC721URIStorageErrors::ERC721IncorrectOwner)
                    }
                ...
                },
                {
                    fn ERC721InvalidReceiver(
                        ...
                        .map(ERC721URIStorageErrors::ERC721InvalidReceiver)
                    }
                ...
                },
                {
                    fn ERC721InvalidSender(
                        ...
                        .map(ERC721URIStorageErrors::ERC721InvalidSender)
                    }
                    ERC721InvalidSender
                },
                {
                    fn ERC721NonexistentToken(
                        ...
                        .map(ERC721URIStorageErrors::ERC721NonexistentToken)
                    }
                ...
                },
                {
                    fn ERC721InvalidOwner(
                        ...
                        .map(ERC721URIStorageErrors::ERC721InvalidOwner)
                    }
                    ERC721InvalidOwner
                },
                {
                    fn ERC721InvalidApprover(
                        ...
                        .map(ERC721URIStorageErrors::ERC721InvalidApprover)
                    }
    ...
    ///Container for all the [`ERC721URIStorage`](self) events.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC721URIStorageEvents {
        const NAME: &'static str = "ERC721URIStorageEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC721URIStorageEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`ERC721URIStorage`](self) contract instance.

    See the [wrapper's documentation](`ERC721URIStorageInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ERC721URIStorageInstance<T, P, N> {
        ERC721URIStorageInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ERC721URIStorageInstance<T, P, N>>>
    {
        ERC721URIStorageInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        ERC721URIStorageInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ERC721URIStorage`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`ERC721URIStorage`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct ERC721URIStorageInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ERC721URIStorageInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC721URIStorageInstance").field(&self.address).finish()
        }
    }
        ...
        > ERC721URIStorageInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ERC721URIStorageInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> ERC721URIStorageInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC721URIStorageInstance<T, P, N> {
