...
pub mod StdAssertions {
    ...
    >(
        ...
        provider: P,
    ) -> StdAssertionsInstance<T, P, N> {
        StdAssertionsInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<StdAssertionsInstance<T, P, N>>>
    {
        StdAssertionsInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        StdAssertionsInstance::<T, P, N>::deploy_builder(provider)
    }
    ...
    #[derive(Clone)]
    pub struct StdAssertionsInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for StdAssertionsInstance<T, P, N> {
        #[inline]
        ...
        > StdAssertionsInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<StdAssertionsInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> StdAssertionsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> StdAssertionsInstance<T, P, N> {
