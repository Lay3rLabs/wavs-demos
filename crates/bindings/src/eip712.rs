...
pub mod EIP712 {
    ...
    impl alloy_sol_types::SolInterface for EIP712Calls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<EIP712Calls>] = &[{
                fn eip712Domain(
                    data: &[u8],
                    validate: bool,
                ) -> alloy_sol_types::Result<EIP712Calls> {
                    <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
    ...
    impl alloy_sol_types::SolInterface for EIP712Errors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<EIP712Errors>] = &[
                {
                    fn StringTooLong(
                        data: &[u8],
                        validate: bool,
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<EIP712Instance<T, P, N>>> {
        ...
        > EIP712Instance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<EIP712Instance<T, P, N>> {
