...
pub mod IERC721Receiver {
        ...
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for onERC721ReceivedCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self { operator: tuple.0, from: tuple.1, tokenId: tuple.2, data: tuple.3 }
                }
            }
        }
        {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC721ReceiverInstance<T, P, N>>>
    {
        ...
        > IERC721ReceiverInstance<T, P, N>
    {
        ...
        pub fn onERC721Received(
            ...
            self.call_builder(&onERC721ReceivedCall { operator, from, tokenId, data })
        }
    }
    /// Event filters.
    #[automatically_derived]
