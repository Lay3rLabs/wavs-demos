...
pub mod IERC5267 {
    ...
    impl alloy_sol_types::SolInterface for IERC5267Calls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<IERC5267Calls>] =
                &[{
                    fn eip712Domain(
                        data: &[u8],
                        validate: bool,
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC5267Instance<T, P, N>>>
    {
        ...
        > IERC5267Instance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IERC5267Instance<T, P, N>> {
