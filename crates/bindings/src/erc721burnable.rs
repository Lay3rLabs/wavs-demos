...
pub mod ERC721Burnable {
    ...
    ///Container for all the [`ERC721Burnable`](self) function calls.
    pub enum ERC721BurnableCalls {
        approve(approveCall),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC721BurnableCalls {
        const NAME: &'static str = "ERC721BurnableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<ERC721BurnableCalls>] = &[
                {
                    fn supportsInterface(
                        ...
                        .map(ERC721BurnableCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                ...
                },
                {
                    fn getApproved(
                        ...
                        .map(ERC721BurnableCalls::getApproved)
                    }
                    getApproved
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721BurnableCalls::approve)
                    }
                    approve
                },
                {
                    fn transferFrom(
                        ...
                        .map(ERC721BurnableCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn safeTransferFrom_0(
                        ...
                        .map(ERC721BurnableCalls::safeTransferFrom_0)
                    }
                    safeTransferFrom_0
                },
                {
                ...
                },
                {
                    fn ownerOf(
                        ...
                        <ownerOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721BurnableCalls::ownerOf)
                    }
                    ownerOf
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721BurnableCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn symbol(
                        ...
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721BurnableCalls::symbol)
                    }
                    symbol
                },
                {
                    fn setApprovalForAll(
                        ...
                        .map(ERC721BurnableCalls::setApprovalForAll)
                    }
                    setApprovalForAll
                },
                {
                    fn safeTransferFrom_1(
                        ...
                        .map(ERC721BurnableCalls::safeTransferFrom_1)
                    }
                    safeTransferFrom_1
                },
                {
                    fn tokenURI(
                        ...
                        <tokenURICall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721BurnableCalls::tokenURI)
                    }
                    tokenURI
                },
                {
                    fn isApprovedForAll(
                        ...
                        .map(ERC721BurnableCalls::isApprovedForAll)
                    }
                    isApprovedForAll
                },
            ];
    ...
    ///Container for all the [`ERC721Burnable`](self) custom errors.
    pub enum ERC721BurnableErrors {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC721BurnableErrors {
        const NAME: &'static str = "ERC721BurnableErrors";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<ERC721BurnableErrors>] = &[
                {
                    fn ERC721InsufficientApproval(
                        ...
                        .map(ERC721BurnableErrors::ERC721InsufficientApproval)
                    }
                ...
                },
                {
                    fn ERC721InvalidOperator(
                        ...
                        .map(ERC721BurnableErrors::ERC721InvalidOperator)
                    }
                ...
                },
                {
                    fn ERC721IncorrectOwner(
                        ...
                        .map(ERC721BurnableErrors::ERC721IncorrectOwner)
                    }
                ...
                },
                {
                    fn ERC721InvalidReceiver(
                        ...
                        .map(ERC721BurnableErrors::ERC721InvalidReceiver)
                    }
                ...
                },
                {
                    fn ERC721InvalidSender(
                        ...
                        .map(ERC721BurnableErrors::ERC721InvalidSender)
                    }
                    ERC721InvalidSender
                },
                {
                    fn ERC721NonexistentToken(
                        ...
                        .map(ERC721BurnableErrors::ERC721NonexistentToken)
                    }
                ...
                },
                {
                    fn ERC721InvalidOwner(
                        ...
                        .map(ERC721BurnableErrors::ERC721InvalidOwner)
                    }
                    ERC721InvalidOwner
                },
                {
                    fn ERC721InvalidApprover(
                        ...
                        .map(ERC721BurnableErrors::ERC721InvalidApprover)
                    }
    ...
    ///Container for all the [`ERC721Burnable`](self) events.
    pub enum ERC721BurnableEvents {
        Approval(Approval),
        ApprovalForAll(ApprovalForAll),
        Transfer(Transfer),
    }
    #[automatically_derived]
    impl ERC721BurnableEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC721BurnableEvents {
        const NAME: &'static str = "ERC721BurnableEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC721BurnableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`ERC721Burnable`](self) contract instance.

    See the [wrapper's documentation](`ERC721BurnableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ERC721BurnableInstance<T, P, N> {
        ERC721BurnableInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ERC721BurnableInstance<T, P, N>>>
    {
        ERC721BurnableInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        ERC721BurnableInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ERC721Burnable`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`ERC721Burnable`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct ERC721BurnableInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ERC721BurnableInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC721BurnableInstance").field(&self.address).finish()
        }
    }
        ...
        > ERC721BurnableInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ERC721BurnableInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> ERC721BurnableInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC721BurnableInstance<T, P, N> {
