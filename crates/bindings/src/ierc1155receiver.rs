...
pub mod IERC1155Receiver {
    ...
    impl IERC1155ReceiverCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] =
            &[[1u8, 255u8, 201u8, 167u8], [188u8, 25u8, 124u8, 129u8], [242u8, 58u8, 110u8, 97u8]];
    }
    #[automatically_derived]
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC1155ReceiverInstance<T, P, N>>>
    {
        ...
        > IERC1155ReceiverInstance<T, P, N>
    {
        ...
        pub fn onERC1155BatchReceived(
            ...
            self.call_builder(&onERC1155BatchReceivedCall { operator, from, ids, values, data })
        }
        ...
        pub fn onERC1155Received(
            ...
            self.call_builder(&onERC1155ReceivedCall { operator, from, id, value, data })
        }
