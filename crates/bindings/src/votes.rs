...
pub mod Votes {
    ...
    impl alloy_sol_types::SolInterface for VotesCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<VotesCalls>] = &[
                {
                    fn getPastVotes(
                        data: &[u8],
                        validate: bool,
                ...
                {
                    fn nonces(data: &[u8], validate: bool) -> alloy_sol_types::Result<VotesCalls> {
                ...
                {
                    fn clock(data: &[u8], validate: bool) -> alloy_sol_types::Result<VotesCalls> {
    ...
    impl alloy_sol_types::SolInterface for VotesErrors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<VotesErrors>] = &[
                {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<VotesInstance<T, P, N>>> {
        ...
        > VotesInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<VotesInstance<T, P, N>> {
