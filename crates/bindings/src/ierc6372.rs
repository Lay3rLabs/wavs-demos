...
pub mod IERC6372 {
    ...
    impl alloy_sol_types::SolInterface for IERC6372Calls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<IERC6372Calls>] = &[
                {
                    fn CLOCK_MODE(
                        data: &[u8],
                        validate: bool,
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC6372Instance<T, P, N>>>
    {
        ...
        > IERC6372Instance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IERC6372Instance<T, P, N>> {
