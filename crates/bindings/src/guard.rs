...
pub mod Guard {
    ...
    ///Container for all the [`Guard`](self) function calls.
    pub enum GuardCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for GuardCalls {
        const NAME: &'static str = "GuardCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<GuardCalls>] = &[
                {
                    fn supportsInterface(
                        data: &[u8],
                        validate: bool,
                    ) -> alloy_sol_types::Result<GuardCalls> {
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            data, validate,
                        )
                        .map(GuardCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn checkTransaction(
                        ...
                        .map(GuardCalls::checkTransaction)
                    }
                    checkTransaction
                },
                {
                    fn checkAfterExecution(
                        ...
                        .map(GuardCalls::checkAfterExecution)
                    }
                    checkAfterExecution
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`Guard`](self) contract instance.

    See the [wrapper's documentation](`GuardInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        ...
        GuardInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<GuardInstance<T, P, N>>> {
        GuardInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        GuardInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`Guard`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`Guard`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct GuardInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for GuardInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("GuardInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
        ...
        > GuardInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<GuardInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> GuardInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> GuardInstance<T, P, N> {
            GuardInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
