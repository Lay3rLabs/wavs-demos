...
pub mod Executor {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ExecutorInstance<T, P, N>>>
    {
        ExecutorInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        ExecutorInstance::<T, P, N>::deploy_builder(provider)
    }
        ...
        > ExecutorInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<ExecutorInstance<T, P, N>> {
