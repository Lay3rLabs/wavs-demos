...
pub mod FallbackManager {
    ...
    >(
        ...
        provider: P,
    ) -> FallbackManagerInstance<T, P, N> {
        FallbackManagerInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<FallbackManagerInstance<T, P, N>>>
    {
        FallbackManagerInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        FallbackManagerInstance::<T, P, N>::deploy_builder(provider)
    }
    ...
    #[derive(Clone)]
    pub struct FallbackManagerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for FallbackManagerInstance<T, P, N> {
        #[inline]
        ...
        > FallbackManagerInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<FallbackManagerInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> FallbackManagerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> FallbackManagerInstance<T, P, N> {
