...
pub mod ERC721 {
    ...
    impl alloy_sol_types::SolInterface for ERC721Calls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<ERC721Calls>] = &[
                {
                ...
                {
                    fn name(data: &[u8], validate: bool) -> alloy_sol_types::Result<ERC721Calls> {
                ...
                {
                    fn symbol(data: &[u8], validate: bool) -> alloy_sol_types::Result<ERC721Calls> {
    ...
    impl alloy_sol_types::SolInterface for ERC721Errors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<ERC721Errors>] = &[
                {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ERC721Instance<T, P, N>>> {
        ...
        > ERC721Instance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<ERC721Instance<T, P, N>> {
