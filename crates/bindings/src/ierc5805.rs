...
pub mod IERC5805 {
    ...
    impl alloy_sol_types::SolInterface for IERC5805Calls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<IERC5805Calls>] = &[
                {
                    fn getPastVotes(
                        data: &[u8],
                        validate: bool,
    ...
    impl alloy_sol_types::SolInterface for IERC5805Errors {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8], bool) -> alloy_sol_types::Result<IERC5805Errors>] =
                &[{
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC5805Instance<T, P, N>>>
    {
        ...
        > IERC5805Instance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IERC5805Instance<T, P, N>> {
