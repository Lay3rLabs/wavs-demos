...
pub mod ERC721Pausable {
    ...
    ///Container for all the [`ERC721Pausable`](self) function calls.
    pub enum ERC721PausableCalls {
        approve(approveCall),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC721PausableCalls {
        const NAME: &'static str = "ERC721PausableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<ERC721PausableCalls>] = &[
                {
                    fn supportsInterface(
                        ...
                        .map(ERC721PausableCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                ...
                },
                {
                    fn getApproved(
                        ...
                        .map(ERC721PausableCalls::getApproved)
                    }
                    getApproved
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721PausableCalls::approve)
                    }
                    approve
                },
                {
                    fn transferFrom(
                        ...
                        .map(ERC721PausableCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn safeTransferFrom_0(
                        ...
                        .map(ERC721PausableCalls::safeTransferFrom_0)
                    }
                    safeTransferFrom_0
                },
                {
                    fn paused(
                        ...
                        <pausedCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721PausableCalls::paused)
                    }
                    paused
                },
                {
                    fn ownerOf(
                        ...
                        <ownerOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721PausableCalls::ownerOf)
                    }
                    ownerOf
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721PausableCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn symbol(
                        ...
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721PausableCalls::symbol)
                    }
                    symbol
                },
                {
                    fn setApprovalForAll(
                        ...
                        .map(ERC721PausableCalls::setApprovalForAll)
                    }
                    setApprovalForAll
                },
                {
                    fn safeTransferFrom_1(
                        ...
                        .map(ERC721PausableCalls::safeTransferFrom_1)
                    }
                    safeTransferFrom_1
                },
                {
                    fn tokenURI(
                        ...
                        <tokenURICall as alloy_sol_types::SolCall>::abi_decode_raw(data, validate)
                            .map(ERC721PausableCalls::tokenURI)
                    }
                    tokenURI
                },
                {
                    fn isApprovedForAll(
                        ...
                        .map(ERC721PausableCalls::isApprovedForAll)
                    }
                    isApprovedForAll
                },
            ];
    ...
    ///Container for all the [`ERC721Pausable`](self) custom errors.
    pub enum ERC721PausableErrors {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC721PausableErrors {
        const NAME: &'static str = "ERC721PausableErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<ERC721PausableErrors>] = &[
                {
                    fn ERC721InsufficientApproval(
                        ...
                        .map(ERC721PausableErrors::ERC721InsufficientApproval)
                    }
                ...
                },
                {
                    fn ERC721InvalidOperator(
                        ...
                        .map(ERC721PausableErrors::ERC721InvalidOperator)
                    }
                ...
                },
                {
                    fn ERC721IncorrectOwner(
                        ...
                        .map(ERC721PausableErrors::ERC721IncorrectOwner)
                    }
                ...
                },
                {
                    fn ERC721InvalidReceiver(
                        ...
                        .map(ERC721PausableErrors::ERC721InvalidReceiver)
                    }
                ...
                },
                {
                    fn ERC721InvalidSender(
                        ...
                        .map(ERC721PausableErrors::ERC721InvalidSender)
                    }
                    ERC721InvalidSender
                },
                {
                    fn ERC721NonexistentToken(
                        ...
                        .map(ERC721PausableErrors::ERC721NonexistentToken)
                    }
                ...
                },
                {
                    fn ERC721InvalidOwner(
                        ...
                        .map(ERC721PausableErrors::ERC721InvalidOwner)
                    }
                    ERC721InvalidOwner
                },
                {
                    fn ExpectedPause(
                        ...
                        <ExpectedPause as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
                            .map(ERC721PausableErrors::ExpectedPause)
                    }
                    ExpectedPause
                },
                {
                    fn ERC721InvalidApprover(
                        ...
                        .map(ERC721PausableErrors::ERC721InvalidApprover)
                    }
                ...
                },
                {
                    fn EnforcedPause(
                        ...
                        <EnforcedPause as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
                            .map(ERC721PausableErrors::EnforcedPause)
                    }
                    EnforcedPause
                },
            ];
    ...
    ///Container for all the [`ERC721Pausable`](self) events.
    pub enum ERC721PausableEvents {
        Approval(Approval),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC721PausableEvents {
        const NAME: &'static str = "ERC721PausableEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC721PausableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`ERC721Pausable`](self) contract instance.

    See the [wrapper's documentation](`ERC721PausableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ERC721PausableInstance<T, P, N> {
        ERC721PausableInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ERC721PausableInstance<T, P, N>>>
    {
        ERC721PausableInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        ERC721PausableInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ERC721Pausable`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`ERC721Pausable`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct ERC721PausableInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ERC721PausableInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC721PausableInstance").field(&self.address).finish()
        }
    }
        ...
        > ERC721PausableInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ERC721PausableInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> ERC721PausableInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC721PausableInstance<T, P, N> {
