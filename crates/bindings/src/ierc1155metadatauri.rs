...
pub mod IERC1155MetadataURI {
    ...
    ///Container for all the [`IERC1155MetadataURI`](self) function calls.
    ...
    ///Container for all the [`IERC1155MetadataURI`](self) events.
    ...
    /**Creates a new wrapper around an on-chain [`IERC1155MetadataURI`](self) contract instance.

    See the [wrapper's documentation](`IERC1155MetadataURIInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC1155MetadataURIInstance<T, P, N> {
        IERC1155MetadataURIInstance::<T, P, N>::new(address, provider)
    }
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC1155MetadataURIInstance<T, P, N>>>
    {
        IERC1155MetadataURIInstance::<T, P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IERC1155MetadataURIInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC1155MetadataURI`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IERC1155MetadataURI`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IERC1155MetadataURIInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC1155MetadataURIInstance<T, P, N> {
        #[inline]
        ...
        > IERC1155MetadataURIInstance<T, P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC1155MetadataURIInstance<T, P, N>> {
    ...
    impl<T, P: ::core::clone::Clone, N> IERC1155MetadataURIInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC1155MetadataURIInstance<T, P, N> {
